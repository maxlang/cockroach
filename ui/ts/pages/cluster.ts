  ...
  export module Cluster {
    ...
    export module Page {
      class Controller {
        ...
        // TOOD: better pattern
        public eventRefresher: { callback: () => void; } = {
          callback: null
        };
        ...
        public constructor(nodeId?: string) {
          ...
          this._addChartSmall(
            Metrics.NewAxis(
              Metrics.Select.Avg(_nodeMetric("sql.transaction.begincount"))
                .sources(this.sources) // TODO: store sources vs node sources
                .title("Transactions")
        ...
        private _refresh(): void {
          ...
          if (this.eventRefresher.callback) {
            this.eventRefresher.callback();
          }
        }
      ...
      export function view(ctrl: Controller): MithrilElement {
        ...
        return m(".page", [
          ...
          m(".section.table", m.component(Components.Events, ctrl.eventRefresher)),
        ]);
      }
    }
  }
