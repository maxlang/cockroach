...
import { AdminUIState, MetricsQuery, TimeWindowState } from "../redux/state";
import { queryMetrics } from "../redux/metrics";
...
let timeSpanSelector = createSelector(
  (state: AdminUIState) => state.timewindow as TimeWindowState,
  (tw) => {
